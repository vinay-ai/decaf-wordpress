...
class Subject
{
     ...
     */
    public function addUse(\Google\Web_Stories_Dependencies\enshrined\svgSanitize\ElementReference\Subject $subject)
    {
        if ($subject === $this) {
        ...
        $this->useCollection[$identifier] = new \Google\Web_Stories_Dependencies\enshrined\svgSanitize\ElementReference\Usage($subject);
    }
    /**
     * @param Subject $subject
     */
    public function addUsedIn(\Google\Web_Stories_Dependencies\enshrined\svgSanitize\ElementReference\Subject $subject)
    {
        if ($subject === $this) {
        ...
        $this->usedInCollection[$identifier] = new \Google\Web_Stories_Dependencies\enshrined\svgSanitize\ElementReference\Usage($subject);
    }
    /**
    ...
    {
        $elements = \array_map(function (\Google\Web_Stories_Dependencies\enshrined\svgSanitize\ElementReference\Usage $usage) {
