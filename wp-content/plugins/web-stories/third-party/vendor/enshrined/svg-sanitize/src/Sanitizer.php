...
class Sanitizer
{
    ...
    function __construct()
    {
        ...
        $this->allowedAttrs = \array_map('strtolower', \Google\Web_Stories_Dependencies\enshrined\svgSanitize\data\AllowedAttributes::getAttributes());
        $this->allowedTags = \array_map('strtolower', \Google\Web_Stories_Dependencies\enshrined\svgSanitize\data\AllowedTags::getTags());
    }
    /**
     ...
     */
    public function setAllowedTags(\Google\Web_Stories_Dependencies\enshrined\svgSanitize\data\TagInterface $allowedTags)
    {
     ...
     */
    public function setAllowedAttrs(\Google\Web_Stories_Dependencies\enshrined\svgSanitize\data\AttributeInterface $allowedAttrs)
    {
    ...
    public function sanitize($dirty)
    {
        ...
        $xPath = new \Google\Web_Stories_Dependencies\enshrined\svgSanitize\data\XPath($this->xmlDocument);
        $this->elementReferenceResolver = new \Google\Web_Stories_Dependencies\enshrined\svgSanitize\ElementReference\Resolver($xPath, $this->useNestingLimit);
    ...
    {
        $href = \Google\Web_Stories_Dependencies\enshrined\svgSanitize\Helper::getElementHref($element);
    ...
    protected function isUseTagExceedingThreshold(\DOMElement $element)
    {
        ...
        $useId = \Google\Web_Stories_Dependencies\enshrined\svgSanitize\Helper::extractIdReferenceFromHref(\Google\Web_Stories_Dependencies\enshrined\svgSanitize\Helper::getElementHref($element));
        if ($useId === null) {
            return \false;
        }
