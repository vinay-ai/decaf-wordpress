 ...
 */
final class MaxCssByteCountExceeded extends \OverflowException implements \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpException
{
    /**
     ...
     * @return self
     */
    public static function forInlineStyle(\Google\Web_Stories_Dependencies\AmpProject\Dom\Element $element, $style)
    {
        $message = "Maximum allowed CSS byte count exceeded for inline style '{$style}': " . new \Google\Web_Stories_Dependencies\AmpProject\Dom\ElementDump($element);
