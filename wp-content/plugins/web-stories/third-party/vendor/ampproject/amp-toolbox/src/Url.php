...
final class Url
{
     ...
     */
    public function __construct($url = null, \Google\Web_Stories_Dependencies\AmpProject\Url $baseUrl = null)
    {
        $parsedUrl = [];
        if ($url !== null) {
            $parsedUrl = \parse_url($url);
            if (\false === $parsedUrl) {
                throw \Google\Web_Stories_Dependencies\AmpProject\Exception\FailedToParseUrl::forUrl($url);
            }
        }
        if ($baseUrl) {
