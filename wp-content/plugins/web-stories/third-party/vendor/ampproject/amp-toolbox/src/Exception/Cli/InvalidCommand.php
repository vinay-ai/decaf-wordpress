 ...
 */
final class InvalidCommand extends \InvalidArgumentException implements \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpCliException
{
    /**
    ...
    public static function forUnregisteredCommand($command)
    {
        ...
        return new self($message, \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpCliException::E_INVALID_CMD);
    }
    /**
