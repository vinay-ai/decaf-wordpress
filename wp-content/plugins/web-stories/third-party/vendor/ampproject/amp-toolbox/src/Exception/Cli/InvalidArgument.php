 ...
 */
final class InvalidArgument extends \InvalidArgumentException implements \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpCliException
{
    /**
    ...
    public static function forUnreadableArguments()
    {
        ...
        return new self($message, \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpCliException::E_ARG_READ);
    }
    /**
    ...
    public static function forMultiCharacterShortOption()
    {
        ...
        return new self($message, \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpCliException::E_OPT_ARG_DENIED);
    }
    /**
