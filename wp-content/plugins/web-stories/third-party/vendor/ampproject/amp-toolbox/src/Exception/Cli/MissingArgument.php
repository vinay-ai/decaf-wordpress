 ...
 */
final class MissingArgument extends \DomainException implements \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpCliException
{
    /**
    ...
    public static function forNoArgument($option)
    {
        ...
        return new self($message, \Google\Web_Stories_Dependencies\AmpProject\Exception\AmpCliException::E_OPT_ARG_REQUIRED);
    }
    /**
