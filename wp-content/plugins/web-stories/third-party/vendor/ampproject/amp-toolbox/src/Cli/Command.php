...
abstract class Command
{
     ...
     */
    public abstract function register(\Google\Web_Stories_Dependencies\AmpProject\Cli\Options $options);
    /**
     * Process the command.
     *
     ...
     */
    public abstract function process(\Google\Web_Stories_Dependencies\AmpProject\Cli\Options $options);
}
