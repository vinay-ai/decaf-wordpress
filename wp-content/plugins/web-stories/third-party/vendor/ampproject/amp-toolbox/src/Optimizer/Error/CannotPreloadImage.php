 ...
 */
final class CannotPreloadImage implements \Google\Web_Stories_Dependencies\AmpProject\Optimizer\Error
{
    use ErrorProperties;
     ...
     * @return self
     */
    public static function fromImageWithSrcsetAttribute(\Google\Web_Stories_Dependencies\AmpProject\Dom\Element $element = null)
    {
        $message = self::SRCSET_STRING;
        if ($element !== null) {
            $message .= "\n" . new \Google\Web_Stories_Dependencies\AmpProject\Dom\ElementDump($element);
        }
