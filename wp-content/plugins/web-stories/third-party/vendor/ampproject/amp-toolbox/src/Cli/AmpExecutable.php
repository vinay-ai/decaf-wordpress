 ...
 */
final class AmpExecutable extends \Google\Web_Stories_Dependencies\AmpProject\Cli\Executable
{
    /**
     ...
     * @var string[]
     */
    const COMMAND_CLASSES = [\Google\Web_Stories_Dependencies\AmpProject\Cli\Command\Optimize::class];
    /**
     ...
     * @return void
     */
    protected function setup(\Google\Web_Stories_Dependencies\AmpProject\Cli\Options $options)
    {
     ...
     * @return void
     */
    protected function main(\Google\Web_Stories_Dependencies\AmpProject\Cli\Options $options)
    {
        ...
        if (!\array_key_exists($commandName, $this->commandInstances)) {
            throw \Google\Web_Stories_Dependencies\AmpProject\Exception\Cli\InvalidCommand::forUnregisteredCommand($commandName);
        }
