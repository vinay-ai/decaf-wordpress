...
class OutputFormat
{
    ...
    public function getFormatter()
    {
        if ($this->oFormatter === null) {
            $this->oFormatter = new \Google\Web_Stories_Dependencies\Sabberworm\CSS\OutputFormatter($this);
        }
    ...
    {
        return new \Google\Web_Stories_Dependencies\Sabberworm\CSS\OutputFormat();
    }
    /**
...
{
    private $oFormat;
    public function __construct(\Google\Web_Stories_Dependencies\Sabberworm\CSS\OutputFormat $oFormat)
    {
    ...
    public function safely($cCode)
    {
        if ($this->oFormat->get('IgnoreExceptions')) {
            ...
            try {
                return $cCode();
            } catch (\Google\Web_Stories_Dependencies\Sabberworm\CSS\Parsing\OutputException $e) {
                return null;
            }
            //Do nothing
        } else {
