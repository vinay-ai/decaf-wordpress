...
class CSSFunction extends \Google\Web_Stories_Dependencies\Sabberworm\CSS\Value\ValueList
{
    protected $sName;
    public function __construct($sName, $aArguments, $sSeparator = ',', $iLineNo = 0)
    {
        if ($aArguments instanceof \Google\Web_Stories_Dependencies\Sabberworm\CSS\Value\RuleValueList) {
