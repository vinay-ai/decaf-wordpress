...
*/
class Import implements \Google\Web_Stories_Dependencies\Sabberworm\CSS\Property\AtRule
{
    private $oLocation;
    private $sMediaQuery;
    protected $iLineNo;
    protected $aComments;
    public function __construct(\Google\Web_Stories_Dependencies\Sabberworm\CSS\Value\URL $oLocation, $sMediaQuery, $iLineNo = 0)
    {
