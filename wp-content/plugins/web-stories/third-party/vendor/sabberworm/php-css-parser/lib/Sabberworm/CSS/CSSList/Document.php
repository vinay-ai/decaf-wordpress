 ...
 */
class Document extends \Google\Web_Stories_Dependencies\Sabberworm\CSS\CSSList\CSSBlockList
{
    /**
    ...
    {
        $oDocument = new \Google\Web_Stories_Dependencies\Sabberworm\CSS\CSSList\Document($oParserState->currentLine());
        \Google\Web_Stories_Dependencies\Sabberworm\CSS\CSSList\CSSList::parseList($oParserState, $oDocument);
        return $oDocument;
    }
    /**
